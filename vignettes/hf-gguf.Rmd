...
#> The sky appears blue due to a process called Rayleigh
#> scattering. Sunlight enters Earth’s atmosphere and hits air
#> molecules, which are much smaller than visible light
#> wavelengths. As sunlight strikes these molecules, they scatter
#> in all directions - think of it like how light bends when
#> passing through a prism.
#> 
#> This scattered light has a bluer hue because shorter blue
#> wavelengths bend more easily due to their size. The reason why
#> the sky looks darker near the horizon is because there's less
#> atmosphere for this scattering effect to occur within;
#> therefore, you get less overall scattering and fewer blue tones
#> hitting your eyes.
#> 
#> So when you look up at night sky during twilight hours or on a
#> particularly clear day without any clouds around, it might
#> appear exceptionally vibrant due to how much light gets
#> scattered back into space by our air molecules!
```
...
#> 1 0.221  0.128 0.698  0.0980 0.891 -0.145  0.168  0.722 -0.308
#> 2 0.240 -0.331 0.699 -0.125  0.856  0.345 -0.0621 0.361 -0.309
#> # ℹ 759 more variables: dim_10 <dbl>, dim_11 <dbl>,
