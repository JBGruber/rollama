...
#> Here's why:
#> 
#> * The word "terrible" is a strong adjective that implies a
#> strongly unfavorable opinion. It suggests that the speaker has
#> had a very poor experience with the pizza.
#> * The tone of the sentence is direct and critical, implying that
#> the speaker was not just mildly dissatisfied but actively
#> disliked the pizza.
#> * There's no nuance or mixed sentiment in this text; it's a
#> straightforward expression of dislike.
#> 
#> Overall, the language and tone used suggest that the speaker had
#> a very negative experience with the pizza.
```
...
#>   role   content                                                 
#>   <chr>  <glue>                                                  
#> 1 system You assign texts into categories. Answer with just the …
...
#>   review_id review                                               
#>       <int> <chr>                                                
#> 1         1 A stunning visual spectacle with a gripping storylin…
#> 2         2 The plot was predictable, but the acting was superb. 
#> 3         3 An overrated film with underwhelming performances.   
#> 4         4 A beautiful tale of love and adventure, beautifully …
#> 5         5 The movie lacked depth, but the special effects were…
```
...
#>       <int> <chr>                                      <chr>     
#> 1         1 A stunning visual spectacle with a grippi… Positive  
#> 2         2 The plot was predictable, but the acting … positive  
#> 3         3 An overrated film with underwhelming perf… Negative  
#> 4         4 A beautiful tale of love and adventure, b… Positive  
#> 5         5 The movie lacked depth, but the special e… Neutral
```
