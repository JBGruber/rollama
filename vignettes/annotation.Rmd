...
For annotation, however, the instruction tuned llama models are often better suited, as they follow instructions more diligently and are less likey to trail off into a conversation.
...
For example, if you want to have an output that easy to parse, you could change the assistant message to `"{'Category':'Negative','Important':'terrible'}"`
