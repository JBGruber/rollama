...
For an annotation task we could write: "You assign texts into categories. Answer with just the correct category."
...
## System message and classification question
...
- Obtains sentiment classification (assumed by `query(q)` function).
