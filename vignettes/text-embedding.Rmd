...
#> $ `Division Name`           <chr> "Initmates", "General", "General", "Gen…
#> $ `Department Name`         <chr> "Intimate", "Dresses", "Dresses", "Bott…
#> $ `Class Name`              <chr> "Intimates", "Dresses", "Dresses", "Pan…
```
...
#> #   dim_39 <dbl>, dim_40 <dbl>, dim_41 <dbl>, dim_42 <dbl>, …
```
...
reviews_embeddings
#> # A tibble: 5,000 × 770
#>       id rating   dim_1 dim_2 dim_3   dim_4  dim_5   dim_6   dim_7  dim_8
#>    <dbl> <fct>    <dbl> <dbl> <dbl>   <dbl>  <dbl>   <dbl>   <dbl>  <dbl>
#>  1     0 <5      1.12   1.56  -4.48 -0.129  -0.373  0.390  -1.24    0.821
#>  2     1 5       0.792  0.721 -3.14 -0.808  -1.81   1.35    0.403  -0.377
#>  3     2 <5      0.539  1.12  -2.58 -0.417  -0.992  1.77    0.895   0.174
#>  4     3 5      -0.150  1.25  -4.12 -0.0750 -0.835  1.06   -0.0965 -0.292
#>  5     4 5       0.352  0.972 -3.40 -1.18   -0.686  0.489   0.127   0.473
#>  6     5 <5      0.907  0.975 -2.78 -0.638  -1.48   2.21    0.373  -0.448
#>  7     6 5       0.523  0.321 -2.46 -0.678  -0.640  0.501   0.703   0.320
#>  8     7 <5      0.224  0.694 -3.12 -0.562  -1.50  -0.0708  0.178   0.144
#>  9     8 5      -0.0477 1.21  -3.70 -0.300  -0.936  0.583   0.135  -0.234
#> 10     9 5      -0.105  1.13  -3.22 -0.310  -1.69   0.857  -0.157  -0.122
#> # ℹ 4,990 more rows
#> # ℹ 760 more variables: dim_9 <dbl>, dim_10 <dbl>, dim_11 <dbl>,
