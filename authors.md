...
- **Maximilian Weber**. Author, contributor.
  [](https://orcid.org/0000-0002-1174-449X)

## Citation

Source:
[`DESCRIPTION`](https://github.com/JBGruber/rollama/blob/v0.3.0/DESCRIPTION)

Gruber J, Weber M (2026). *rollama: Communicate with 'Ollama' to Run
Large Language Models Locally*. R package version 0.3.0,
