...
#> 1 Canada Ottawa          41 North Am… TRUE        English           
#> 2 Canada Ottawa          41 North Am… TRUE        French
```
...
#> 1 Germa… Berlin    84000000 Europe    TRUE        German            
#> 2 Brazil Brasíl… 2150000000 South Am… FALSE       Portuguese        
#> 3 Japan  Tokyo          125 Asia      FALSE       Japanese
```
...
#> [3] "neural machine translation" "sequence modeling"         
#> 
#> $open_access
#> [1] TRUE
```
...
#> ✔ model qwen3-vl:2b pulled successfully!
```
...
#> 1 Cartoon llama chart blue            teal       TRUE         playf…
#> 2 Cartoon llama chart green           teal       TRUE         playf…
#> 3 Cartoon llama chart white           teal       TRUE         playf…
```
...
#> ,"capital": "Ottawa"
#> 
#> ,"population": 41, "continent": "Africa" ,
#> "nato_member": true
...
#> "name": "Canada",
#> "capital": "Ottawa",
#> "population": 41, "continent": "North America",
#> "nato_member": true,
#> "official_languages": ["English", "French"]}
```
...
library(tidyllm)
#> Error:
#> ! package or namespace load failed for 'tidyllm' in dyn.load(file, DLLpath = DLLpath, ...):
#>  unable to load shared object '/home/johannes/R/x86_64-pc-linux-gnu-library/4.5/pdftools/libs/pdftools.so':
#>   libpoppler-cpp.so.2: cannot open shared object file: No such file or directory
...
#> Error in `field_object()`:
#> ! could not find function "field_object"
country_schema_tidyllm
#> Error:
#> ! object 'country_schema_tidyllm' not found
```
